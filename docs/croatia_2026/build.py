...
SPOTS = [
    {
        ...
        "photos": [
            ...
            ("Laundry dries in a small alley in Dubrovnik.jpg",
             "石畳の路地",
    ...
    },
    {
        ...
        "photos": [
            ...
            ("Plitvice Lakes, Croatia, Lower Lakes.JPG",
             "澄みきった湖面",
             "森に囲まれた湖。水の色は光の差しかたで変わります。", False),
        ],
        "notes": [
    ...
    },
    {
        ...
        "photos": [
            ...
            ("Zagreb - Uspinjača (30594980327).jpg",
             "世界一短いケーブルカー",
             "高台の上町へ、わずか1分で登れます。", False),
            ("Estatua de Ban Jelacic, Zagreb, Croacia, 2014-04-20, DD 03.JPG",
             "イェラチッチ広場",
